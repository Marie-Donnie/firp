    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etat', models.CharField(default=b'VI', max_length=2, choices=[(b'VI', b'Vivant'), (b'MO', b'Mort'), (b'DI', b'Disparu')])),
