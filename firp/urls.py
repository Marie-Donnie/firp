...
urlpatterns = [
    ...
    url(r'^fiches/(?P<fiche_id>\d+)/competences/edit$', views.edit_fiche_competences,
        name='edit_fiche_competences'),
    url(r'^fiches/(?P<fiche_id>\d+)/relations/edit$', views.edit_fiche_relations,
        name='edit_fiche_relations'),
    url(r'^fiches/(?P<fiche_id>\d+)/medailles/edit$', views.edit_fiche_medailles,
        name='edit_fiche_medailles'),
